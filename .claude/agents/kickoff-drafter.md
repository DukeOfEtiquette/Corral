...
| Input | Description |
|-------|-------------|
| `kickoff_path` | Repo-root-relative path under `./.claude/artifacts/tmp/`; parent directory must exist |
